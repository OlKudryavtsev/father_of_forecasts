...
- Используй FIFA ranking как сильный сигнал базового уровня команды.
- FIFA ranking может содержать только rank без total_points. Это нормально.
- Если rank есть, рейтинг доступен. Не пиши, что FIFA rank недоступен.
- Если total_points=null, используй только rank.
- Используй последние матчи до турнира для оценки формы.
- Используй историю личных встреч, но не переоценивай старые матчи.
- В объяснении кратко упоминай рейтинг, последние результаты и личные встречи, если они есть в контексте.
