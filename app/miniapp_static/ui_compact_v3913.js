(() => {
  ...
  window.fetch = async function patchedFetch(input, init) {
    ...
    try {
      ...
      const row = findUserRow(rows, dashboard?.user);
      if (!row) return response;

      const rowRank = Number(row.rank || row.position || 0);
      if (rowRank) dashboard.rank = rowRank;
      else {
  ...
  function moveAdminButton() {
    ...
    if (admin.parentElement !== main || admin.nextElementSibling !== rules) main.insertBefore(admin, rules);
  ...
  function installStyles() {
    ...
    style.textContent = `
      .league-header { padding-bottom: 8px !important; margin-bottom: 8px !important; }
      .league-main { grid-template-columns: auto minmax(0,1fr) 40px auto !important; gap: 8px !important; }
      ...
      .league-main .rules-button { padding: 0 14px !important; }
      .league-main .header-admin-button.ff-admin-icon-v3913 {
        width: 40px !important; min-width: 40px !important; max-width: 40px !important;
        padding: 0 !important; margin: 0 !important; display: grid !important; place-items: center !important;
        font-size: 0 !important; color: #70a2ff !important; background: rgba(35,53,91,.88) !important;
        border: 1px solid rgba(90,141,255,.40) !important;
      }
      .league-main .header-admin-button.ff-admin-icon-v3913 .svg-icon { width: 21px !important; height: 21px !important; }
      @media (hover:hover) {
        ...
        .next-match-cta:hover { transform: translateY(-1px) !important; }
      }
      .league-status-row { margin-top: 10px !important; width: 100% !important; }
      .league-status.ff-compact-header-v3913 {
        width: 100% !important; display: grid !important;
        grid-template-columns: repeat(6,minmax(0,1fr)) !important;
        grid-template-rows: 40px 40px !important; gap: 7px !important;
      }
      .league-status.ff-compact-header-v3913 > .header-tournament-selector { grid-column: 1 / 4 !important; grid-row: 1 !important; }
      .league-status.ff-compact-header-v3913 > .header-league-selector { grid-column: 4 / 7 !important; grid-row: 1 !important; }
      .league-status.ff-compact-header-v3913 > .status-section { grid-column: 1 / 3 !important; grid-row: 2 !important; }
      .league-status.ff-compact-header-v3913 > .points { grid-column: 3 / 5 !important; grid-row: 2 !important; }
      .league-status.ff-compact-header-v3913 > .ff-rank-v3913 { grid-column: 5 / 7 !important; grid-row: 2 !important; }
      ...
      .league-status.ff-compact-header-v3913 > .ff-stat-v3913 {
        ...
        margin: 0 !important; box-sizing: border-box !important; border-radius: 13px !important; overflow: hidden !important;
        transition: transform .2s ease, border-color .2s ease, background .2s ease !important;
      }
      .league-status.ff-compact-header-v3913 > .header-tournament-selector,
      .league-status.ff-compact-header-v3913 > .header-league-selector { padding: 0 10px !important; }
      .league-status.ff-compact-header-v3913 > .ff-stat-v3913 {
        padding: 0 7px !important; display: flex !important; align-items: center !important; justify-content: center !important;
      ...
      .league-status.ff-compact-header-v3913 > .ff-rank-v3913::before {
        content: 'Место ' !important; margin-right: 2px !important; font-size: 10px !important;
      }
      .league-status.ff-compact-header-v3913 > .divider { display: none !important; }
      .next-match-hero { padding: 11px !important; border-radius: 20px !important; }
      .next-match-hero-top { margin-bottom: 8px !important; gap: 8px !important; }
      .next-match-kicker { font-size: 12px !important; }
      .next-match-countdown { padding: 4px 8px !important; font-size: 11px !important; }
      .next-match-teams { margin-bottom: 8px !important; gap: 6px !important; }
      .next-match-team { gap: 4px !important; }
      .next-match-team strong { font-size: 13px !important; }
      .next-match-team .flag { width: 44px !important; height: 32px !important; }
      body.ucl-active .next-match-team .flag { width: 66px !important; height: 66px !important; border-radius: 14px !important; }
      ...
      .next-match-status { min-height: 34px !important; margin-bottom: 8px !important; padding: 6px 9px !important; border-radius: 12px !important; gap: 6px !important; }
      .next-match-status > span { width: 18px !important; height: 18px !important; }
      ...
      .next-match-cta { min-height: 40px !important; height: 40px !important; border-radius: 13px !important; font-size: 13px !important; transition: transform .2s ease, filter .2s ease !important; }
      @media (max-width: 390px) {
        .league-main { grid-template-columns: auto minmax(0,1fr) 38px auto !important; gap: 7px !important; }
        .league-main .rules-button,
        .league-main .header-admin-button.ff-admin-icon-v3913 { height: 38px !important; min-height: 38px !important; max-height: 38px !important; }
        ...
        .league-status.ff-compact-header-v3913 { grid-template-rows: 38px 38px !important; gap: 6px !important; }
        .league-status.ff-compact-header-v3913 > .header-tournament-selector,
        .league-status.ff-compact-header-v3913 > .header-league-selector,
        .league-status.ff-compact-header-v3913 > .ff-stat-v3913 { height: 38px !important; min-height: 38px !important; max-height: 38px !important; border-radius: 12px !important; }
        .league-status.ff-compact-header-v3913 > .header-tournament-selector,
