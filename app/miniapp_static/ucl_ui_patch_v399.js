(() => {
  ...
  function install() {
    ...
    style.textContent = `
      ...
      body.ucl-active .league-status.ucl-status-v398 .ucl-score-rank .points {
        min-width: 0 !important;
      ...
      body.ucl-active .league-status.ucl-status-v398 .ucl-score-rank > .muted {
        ...
        background: rgba(89, 122, 255, .18) !important;
        border-left: 1px solid rgba(117, 151, 255, .40) !important;
      ...
      @media (max-width: 390px) {
        ...
        body.ucl-active .league-status.ucl-status-v398 .ucl-score-rank {
          grid-template-columns: minmax(0,1fr) minmax(0,.68fr) !important;
        }
        body.ucl-active .league-status.ucl-status-v398 .ucl-score-rank > .muted::before {
          content: '№' !important;
