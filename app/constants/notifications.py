...
NOTIFICATION_OPTIONS = [
    {
        ...
        "description": "Личные напоминания о матчах и проверка прогноза за час до старта.",
        "default": True,
    },
    {
        "key": "group_activity",
        "title": "Активность участников",
        "description": "Прогнозы на матчи и турнирные прогнозы участников в личку и в чаты лиг.",
        "default": True,
    },
    {
        "key": "match_started",
    ...
    },
    {
        "key": "match_videos",
        "title": "Видео матчей",
        "description": "Уведомления, когда для матча появляются голы и лучшие моменты.",
        "default": True,
    },
]
